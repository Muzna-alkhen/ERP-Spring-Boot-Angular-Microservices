...
public class EmailService {
	...
	public void sendEmailWithAttachment(MultipartFile multipartFile , EmailTemplate emailTemplate) throws MessagingException, IOException {
		...
		try {
			if (attchEmailAddr.contains(",")) {
				...
				for (int i = 0; i < receipantSize; i++) {
					...
					helper.setText("<h1>" + "Find the Attachment file" + "</h1>" + emailTemplate.getBody(), true);
